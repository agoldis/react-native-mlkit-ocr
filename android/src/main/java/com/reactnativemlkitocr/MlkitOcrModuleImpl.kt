...
class MlkitOcrModuleImpl {

  companion object {
    const val NAME = "MlkitOcr"

    fun detectFromResource(context: ReactApplicationContext, path: String, promise: Promise) {
      val image: InputImage;
      try {
        image = InputImage.fromFilePath(context, Uri.parse(path))
